...
class MainActivity : AppCompatActivity(), LensChromeClient.ProgressHost {
    ...
    private lateinit var btnRefresh: ImageButton; private lateinit var btnTabs: ImageButton
    private lateinit var btnHome: ImageButton
    private val prefs by lazy { getSharedPreferences("shield", MODE_PRIVATE) }
    private var isDesktopMode = false; private var currentProfile = ShieldProfile.DEFAULT
    private var isLoading = false

    companion object {
        val HOME_HTML = """<!DOCTYPE html><html lang="zh"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:-apple-system,sans-serif;background:#1a1a2e;color:#e0e0e0;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:24px}.logo{font-size:48px;margin-bottom:8px}.title{font-size:24px;font-weight:700;color:#89b4fa;margin-bottom:4px}.sub{font-size:13px;color:#6c7086;margin-bottom:32px}.links{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;width:100%;max-width:360px}.link{background:#232340;border-radius:12px;padding:16px 8px;text-align:center;color:#a6adc8;text-decoration:none;font-size:13px;transition:background .2s}.link:active{background:#313256}.link .ic{font-size:24px;display:block;margin-bottom:6px}</style></head><body><div class="logo">&#x1f9ea;</div><div class="title">镜界</div><div class="sub">轻量 · 隐私 · 指纹隔离</div><div class="links"><a class="link" href="https://www.baidu.com"><span class="ic">&#x1f50d;</span>百度</a><a class="link" href="https://www.bing.com"><span class="ic">&#x1f310;</span>Bing</a><a class="link" href="https://github.com"><span class="ic">&#x1f4bb;</span>GitHub</a><a class="link" href="https://www.zhihu.com"><span class="ic">&#x1f4d6;</span>知乎</a><a class="link" href="https://www.bilibili.com"><span class="ic">&#x1f3ac;</span>B站</a><a class="link" href="https://www.douyin.com"><span class="ic">&#x1f3b5;</span>抖音</a></div></body></html>"""
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState); setContentView(R.layout.activity_main)
        drawer=findViewById(R.id.drawer_layout); toolbar=findViewById(R.id.toolbar)
        navView=findViewById(R.id.nav_view); webView=findViewById(R.id.webview)
        urlBar=findViewById(R.id.url_bar); progressBar=findViewById(R.id.progress_bar)
        swipeRefresh=findViewById(R.id.swipe_refresh); btnBack=findViewById(R.id.btn_back)
        btnForward=findViewById(R.id.btn_forward); btnRefresh=findViewById(R.id.btn_refresh)
        btnTabs=findViewById(R.id.btn_tabs); btnHome=findViewById(R.id.btn_home)
